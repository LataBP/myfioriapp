sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("git/MygitDemo/app", ".html");
		sHash = sHash || "";
	...
	return Opa5.extend("git.MygitDemo.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["git/MygitDemo/localService/mockserver"], function (mockserver) {
