sap.ui.define([
		...
		"use strict";
		return BaseObject.extend("git.MygitDemo.controller.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias git.MygitDemo.controller.ListSelector
			 */
			 ...
			 * @return {git.MygitDemo.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
